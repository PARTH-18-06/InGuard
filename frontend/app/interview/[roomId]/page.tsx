...
Return ONLY valid JSON, no markdown, no explanation:
{
  ...
  useEffect(() => {
    const handler = () => {
      console.log('[InGuard] inguard-tab-hidden event received');
      const now = Date.now();
    ...
    window.addEventListener('inguard-tab-hidden', handler);
    return () => window.removeEventListener('inguard-tab-hidden', handler);
  }, []);
